// g++ ex11-1-1-boxTypeImp.cpp ex11-1-1-rectangleTypeImp.cpp ex11-2-testProgInheritance.cpp -o ex11-2-testProgInheritance.out

#include <iostream>                                  //Line 1
#include <iomanip>                                   //Line 2
#include "ex11-1-1-rectangleType.h"                  //Line 3
#include "ex11-1-1-boxType.h"                        //Line 4
