...
int main()
{
    // This declaration defines an array of size 10, that is, a block of 10 consecutive 
    // objects named a[0], a[1],...,a[9].
    int a[10] = {10, 4, 7, 2, 9, 1, 5, 8, 3, 6} ;
    cout << "int a[10] = {10, 4, 7, 2, 9, 1, 5, 8, 3, 6} ;" << endl ;
